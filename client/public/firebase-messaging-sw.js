...
importScripts('https://www.gstatic.com/firebasejs/4.8.1/firebase-messaging.js');
  ...
  self.addEventListener('push', event => {
    ...
    // self.registration.showNotification(data2.title, {
    //   body: '',
    //   icon: '/favicon.png'
    // });
    ...
    }else if(data2.body.messageType === "video" || data2.body.messageType === "audio"){
      tempTitle = data2.title;
      tempurl = "/doctor/appointmentListing?appointment_id=" + data2.body.channel + "&&date="+data2.body.appointmentDate + "&callerName=" + data2.body.callerName+'&token=' + encodedToken + '&uid='+data2.body.uid + '&type=call&callerId='+data2.body.callerId+"&callerProfile="+data2.body.callerProfile;
      tempBody = 'Click here'
    ...
    }else if(data2.body.messageType === "text" || data2.body.messageType === "file" || data2.body.messageType === "photo"){
      self.registration.showNotification(tempTitle, {
        body: tempBody,
        icon: '/favicon.png',
        data: {
