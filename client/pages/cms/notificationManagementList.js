...
import NotificationContentTable from "../../components/notification-management/NotificationManagementTable";
import NotificationContentHeader from "../../components/notification-management/notificationContentHeader";
import MessagePrompt from "../../components/messagePrompt";
import { useRouter, router } from "next/router";

export default function notificationContentTable() {
  ...
  const TITLE = "Unify Care - Notification Management List";
  ...
  useEffect(() => {
    ...
    if (
      ...
      !getUserPermission.cms.viewChecked &&
      !getUserPermission.cms.editChecked
    ) {
      setLoader(true);
      setMsgData({
        message:
          "Unauthorized Access. Request your Administrator for the access",
        type: "error",
      });
