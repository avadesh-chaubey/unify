...
import AddSpeciality from "../../components/add-doctor/addSpecialitiestoUnit";
...
const TITLE = "Unify Care - Add Speciality to Hospital Unit";
    ...
    <div>
      <AlertProvider template={AlertTemplate} {...options}>
        ...
        <div className="right-area listing">
          <Header name="Add Speciality to Hospital Unit" />
          <AddSpeciality
            setLoader={setLoader}
