    ...
    <div>
      ...
      {view === 0 && <div className="pageView">
        <DialogTitle id="alert-dialog-title">
          ...
          <div style={{marginLeft:"50px", fontSize:"20px", fontWeight:"bold"}}>Select Prescription</div>
        </DialogTitle>
                ...
                <Paper className="apmtcardStyle">
                  <div>
                    ...
                    {/* <div className="cardBottomSec">
                      ...
                      <div style={{color:"#000", fontSize:"14px", fontWeight:"bold", width:"50%"}}>
                        {item.slotLabel} {moment(item.appointmentDate).format('DD-MMM-YYYY')}
                      </div>
                    </div> */}
                  </div>
      ...
      {view === 1 && <div className="pageView confirmOrder">
        ...
        {/* {userDetails.testPrescription.length >0 ? */}
        <div>
          ...
          <div>
            <div style={{margin:"15px 30px",fontSize:"20px", fontWeight:"bold"}}>Tests</div>
            <div className="details">
              ...
              {userDetails.testPrescription.length < 1 && <div>No Test Prescribed</div>}
            </div>
            {userDetails.testPrescription.length >0 && <div>
              <div className="details">
            ...
            {userDetails.testPrescription.length >0 && <div style={{textAlign:"center", marginTop:"30px"}}>
              <Button
                id="OTP Submit Btn"
                size="small"
                variant="contained"
